...
class SeoService
{
    ...
    {
        return [
            'title'       => Setting::get('seo_title', 'Eren Abiye — Özel Tasarım Abiye Modelleri'),
            'description' => Setting::get('seo_description', 'En şık abiye modelleri, özel tasarımlar ve uygun fiyatlarla Eren Abiye\'de.'),
            'keywords'    => Setting::get('seo_keywords', 'abiye, uzun abiye, kısa abiye, özel tasarım abiye'),
