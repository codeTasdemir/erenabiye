...
<body>
    <div class="container">
        ...
        <div>
            ...
            <div class="card">
                ...
                <div class="bin-input-group">
                    <input type="text" id="bin-input" maxlength="6" placeholder="123456"
        ...
        <div class="card">
            ...
            <iframe src="https://www.paytr.com/odeme/guvenli/{{ $iframeToken }}" id="paytriframe" scrolling="no">
            </iframe>
        </div>
